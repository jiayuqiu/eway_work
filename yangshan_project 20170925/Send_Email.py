...
def send_email_n(to_addr, warning_str, subject_str,
               from_addr='qiujiayu0212@163.com',
               password='yingming0403',
               smtp_server='smtp.163.com'):
    print "sending......................"
    print to_addr, warning_str, subject_str
...
if __name__ == "__main__":
    print "1"
    send_email_n(to_addr=["sohu.321@qq.com"], warning_str="123", subject_str="123")
    print "2"
